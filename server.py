...
async def search_papers(query: str, platform: str = "CNKI", search_field: str = "主题", db_scope: str = "总库", source_type: str = "all", start_index: int = 0, limit: int = 10) -> str:
    ...
    - platform: Target platform. "CNKI", "IEEE", "ARXIV", "ACM", or "SD". Default is "CNKI".
...
async def get_paper_details(url: str, platform: str = "CNKI") -> str:
    ...
    - url: The absolute URL of the CNKI/IEEE/ARXIV/ACM paper detail page (detail_link from search results).
    - platform: Target platform. "CNKI", "IEEE", "ARXIV", or "ACM". Default is "CNKI".
    """
    scraper = get_scraper(platform)
...
async def download_paper(url: str, output_dir: str, platform: str = "CNKI") -> str:
    ...
    - url: The absolute URL of the CNKI/IEEE/ARXIV/ACM paper detail page.
